...
//        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:oracle:thin:@110.41.20.233:1521:xe",
//                "root", "123456").build();
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:postgresql://110.41.20.233:5432/ruoyi-vue-pro",
                "root", "123456").build();
